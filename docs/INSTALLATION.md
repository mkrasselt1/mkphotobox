# MKPhotobox — Installation und Betrieb

Dieses Dokument richtet sich an die Person, die die Box **aufsetzt und betreibt**:
Systemvoraussetzungen, Installation, Updates, Fernzugang und die Stolpersteine,
über die man dabei fällt.

Was die Box kann und wie ein Abend damit abläuft, steht im
[README](../README.md). Fragen zur **Bedienung** („wie richte ich eine
Veranstaltung ein?") beantwortet das Handbuch in der App selbst unter
**Admin → Hilfe** — es liegt immer auf der Box und passt zur installierten Version.
