...
def get_display_config():
    ...
    return {
        ...
        "sound_enabled": get_nested(cfg, "session.sound_enabled", True),
        "sound_volume": get_nested(cfg, "session.sound_volume", 0.6),
        "flash_enabled": get_nested(cfg, "session.flash_enabled", True),
        "guestbook_enabled": get_nested(cfg, "guestbook.enabled", True),
        "guestbook_max_len": get_nested(cfg, "guestbook.max_message_len", 120),
